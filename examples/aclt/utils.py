...
class InputExample(object):
    ...
    def __init__(self, guid, text_a, text_b=None, label=None,label_roots=None):
        self.guid = guid
        self.text_a = text_a
        self.text_b = text_b
        self.label = label
...
class InputFeatures(object):
    ...
    def __init__(self, root_ids,input_ids, attention_mask=None, token_type_ids=None, label=None):
...
class DataProcessor(object):
    ...
    def _read_tsv(cls, input_file,quotechar='"'):
        csv.field_size_limit(sys.maxsize)
        """Reads a tab separated value file."""
        with open(input_file, "r", encoding="utf-8") as f:#,errors='ignore'
